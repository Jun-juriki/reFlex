# Generated by Django 6.0.4 on 2026-04-16 23:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('diagnosis', models.TextField(verbose_name='Диагноз (ввод врача)')),
                ('diagnosis_detail', models.TextField(blank=True, null=True, verbose_name='Уточнение/Анамнез')),
                ('limitation_type', models.TextField(verbose_name='Тип ограничения (ввод врача)')),
                ('baseline_value', models.FloatField()),
                ('baseline_unit', models.CharField(default='m', max_length=50, verbose_name='Единицы измерения')),
                ('baseline_condition', models.TextField(blank=True, null=True, verbose_name='Условия замера (например, с опорой)')),
                ('target_value', models.FloatField(blank=True, null=True)),
                ('target_unit', models.CharField(default='m', max_length=50)),
                ...
                ('training_program', models.JSONField(blank=True, default=list)),
                ('strikes', models.IntegerField(default=0)),
                ('max_strikes', models.IntegerField(default=3)),
                ('is_goal_valid', models.BooleanField(default=True)),
